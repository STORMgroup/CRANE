...
In order to evaluate CRANE, make sure you have followed the steps in [test](../../), and have downloaded and prepared the necessary dataset in [data/crane_datasets](../../data/crane_datasets).
